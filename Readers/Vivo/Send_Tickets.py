...
def __concat_history_without_desig__(df: pd.DataFrame, file: str, sheet_name: str) -> pd.DataFrame:  # noqa
...
if __name__ == '__main__':
    ...
    df = pd.read_csv(
        fr"{os.environ['OneDrive']}\Publico\NYCOLAS\01 - PROJETOS\Automacao Spring Control\Logs\vivo_files.csv",
        sep=';',
        decimal=',',
        encoding='utf-8')
